...
import com.face.networkscan.BR;
import com.face.networkscan.R;
import com.face.networkscan.databinding.ActivityNetworkscanBinding;
...
public class NetWorkScanAty extends BaseActivity<ActivityNetworkscanBinding, NetWorkScanViewModule> {
    ...
    public void initViewObservable() {
        ...
        int netErrCountPosition = SPUtils.getInstance().getInt("errScanCountPosition", 3);
